...
class Config:
    ...
    # Database configuration - handle Render's postgres:// to postgresql:// conversion
    ...
    SESSION_COOKIE_SECURE = os.environ.get('ENVIRONMENT') == 'production'  # Auto-detect production
